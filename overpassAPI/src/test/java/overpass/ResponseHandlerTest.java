...
public class ResponseHandlerTest {
	...
	public void singleBOS() throws Exception {
		...
		// Test
		String resIs = ResponseHandler.getResponse(RequestHandler
				.getRelevantBOS(testStr, 49.97656, 8.23063, 49.98074, 8.24163));
	...
	public void bosList() throws Exception {
		...
		// Test
		String resIs = ResponseHandler.getResponse(RequestHandler
				.getRelevantBOS(testStr, 49.96933, 8.1776, 50.03619, 8.35373));
	...
	public void badInput() throws Exception {
		...
		// Test
		String resIs = ResponseHandler.getResponse(RequestHandler
				.getRelevantBOS(testStr, 49.97724, 8.2212, 49.98142, 8.2322));
		// Asserts
		assertNotNull("Ergebnis darf nicht null sein", resIs);
		assertEquals(resIs, resShould);
	}
